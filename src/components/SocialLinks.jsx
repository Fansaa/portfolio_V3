...
const SocialLinks = () => {
  ...
  const socialLinks = [
    {
      name: "LinkedIn",
      displayName: t('social.letsConnect'),
      subText: t('social.onLinkedIn'),
      icon: Linkedin,
      url: "https://www.linkedin.com/in/fathansanum/",
      color: "#0A66C2",
    ...
    },
    {
      ...
      subText: "@fathansanum",
      icon: Instagram,
      url: "https://www.instagram.com/fathansanum",
      color: "#E4405F",
    ...
    },
    {
      ...
      subText: "@fathansanum",
      icon: Youtube,
      url: "https://www.youtube.com/@fathansanum",
      color: "#FF0000",
  ...
  return (
    <div className="w-full bg-gradient-to-br from-gray-100 to-gray-50 dark:from-white/10 dark:to-white/5 rounded-2xl p-6 py-8 backdrop-blur-xl border border-gray-200 dark:border-transparent">
      <h3
        className="text-xl font-semibold text-gray-800 dark:text-white mb-6 flex items-center gap-2"
        data-aos="fade-down"
      >
        <span className="inline-block w-8 h-1 bg-amber-700 rounded-full"></span>
      ...
      <div className="flex flex-col gap-4">
        ...
        <a
          ...
          className="group relative flex items-center justify-between p-4 rounded-lg 
                     bg-white dark:bg-white/5 border border-gray-200 dark:border-white/10 overflow-hidden
                     hover:border-gray-300 dark:hover:border-white/20 transition-all duration-500"
          data-aos="fade-up"
          data-aos-delay="100"
        >
          ...
          <div className="relative flex items-center gap-4">
            ...
            <div className="flex flex-col">
              <span className="text-lg font-bold pt-[0.2rem] text-gray-700 dark:text-gray-200 tracking-tight leading-none group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300">
          ...
          {/* External Link */}
          <ExternalLink
            className="relative w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-gray-700 dark:group-hover:text-white
          ...
          {[instagram, youtube].map((link, index) => (
            ...
            >
              ...
              <div className="flex flex-col min-w-0">
                <span className="text-sm font-bold text-gray-700 dark:text-gray-200 group-hover:text-gray-900 dark:group-hover:text-white transition-colors duration-300">
                  {link.displayName}
                </span>
                <span className="text-xs text-gray-500 dark:text-gray-400 truncate group-hover:text-gray-600 dark:group-hover:text-gray-300 transition-colors duration-300">
                  {link.subText}
                </span>
              </div>

              <ExternalLink
                className="w-4 h-4 text-gray-400 dark:text-gray-500 group-hover:text-gray-700 dark:group-hover:text-white ml-auto
                                       opacity-0 group-hover:opacity-100 transition-all duration-300
            ...
            >
              ...
              <div className="relative flex items-center justify-center">
                ...
                <div className="relative p-2 rounded-lg">
                  <link.icon
                    className="w-5 h-5 transition-all duration-500 group-hover:scale-110"
                    style={{ color: link.colorDark || link.color }}
                  />
                </div>
              </div>
