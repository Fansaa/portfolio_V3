...
Let me introduce myself, I'm **Fathan Fardian Sanum**. On this occasion, I'd like to share the portfolio website project that I've developed.

## 🚀 Live Demo

**Website Link:** [https://www.fathansanum.com/](https://www.fathansanum.com/)
...
```bash
git clone https://github.com/Fansaa/portfolio_V3.git
cd portfolio_V2
```
...
VALUES ('Created By Fathan Fardian Sanum', 'Fansa');
...
**Fathan Fardian Sanum**
  ...
  - Website: [https://www.fathansanum.com/](https://www.fathansanum.com/)
  - GitHub: [Fansaa](https://github.com/Fansaa)
